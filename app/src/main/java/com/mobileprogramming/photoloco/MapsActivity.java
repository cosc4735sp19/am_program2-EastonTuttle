...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        //mLastKnownLocation = fusedLocationClient.getLastLocation().getResult().getl;
        LatLng currentLocation = new LatLng(fusedLocationClient.getLastLocation().getResult().getLatitude(), fusedLocationClient.getLastLocation().getResult().getLongitude());
